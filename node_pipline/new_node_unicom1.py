...
def main():
    ...
    save_dir = r"/data/menghaoding/thu_xwh/new_unicom1_fold1"
    load_dir = r"/data/menghaoding/thu_xwh/new_unicom0_fold1"
    ...
    # Unicom_n5 (8x8x8, 256 channels, single hyperedge from unet2 to unet1)
    ...
    # Unicom_n9 (64x64x64, connecting unet2 n0-n4, n14 to unet1 n0-n4, n14)
    ...
    task_configs = {
        ...
        "type_cls_n6": {
            "loss": [
                {"fn": node_focal_loss, "origin_node": "n131", "target_node": "n135", "weight": 0.5, "params": {"alpha": [x / invs_sum for x in invs], "gamma": 0}},
            ],
            "metric": [
        ...
        "type_cls_n7": {
            "loss": [
                {"fn": node_focal_loss, "origin_node": "n132", "target_node": "n135", "weight": 0.25, "params": {"alpha": [x / invs_sum for x in invs], "gamma": 0}},
            ],
            "metric": [
        ...
        "type_cls_n8": {
            "loss": [
                {"fn": node_focal_loss, "origin_node": "n133", "target_node": "n135", "weight": 0.125, "params": {"alpha": [x / invs_sum for x in invs], "gamma": 0}},
            ],
            "metric": [
        ...
        "type_cls_n9": {
            "loss": [
                {"fn": node_focal_loss, "origin_node": "n134", "target_node": "n135", "weight": 0.0625, "params": {"alpha": [x / invs_sum for x in invs], "gamma": 0}},
            ],
            "metric": [
    ...
    optimizer = optim.Adam([
        {'params': pretrained_params_classifier, 'lr': learning_rate / 2, 'weight_decay': weight_decay},
        {'params': pretrained_params_unet1, 'lr': learning_rate / 2, 'weight_decay': weight_decay / 2},
        {'params': new_params, 'lr': learning_rate, 'weight_decay': weight_decay / 2}
    ])
