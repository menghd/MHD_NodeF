...
def main():
    ...
    # UNet1 configuration (combining encoder1 and decoder1)
    node_configs_unet1 = {
        "n0": (1, 64, 64, 64),    # Input
        "n1": (1, 64, 64, 64),
        "n2": (1, 64, 64, 64),
        ...
        "n15": (32, 64, 64, 64),  # Output to unet2, unicom_n9
    }
    ...
    # UNet2 configuration (combining encoder2 and decoder2)
    node_configs_unet2 = {
        "n0": (32, 64, 64, 64),   # Input from unet1 n15
        "n5": (32, 64, 64, 64),
        "n6": (64, 32, 32, 32),
        "n7": (128, 16, 16, 16),
        "n8": (256, 8, 8, 8),
        ...
        "n13": (32, 64, 64, 64),
        "n14": (32, 64, 64, 64),  # Intermediate output
        "n15": (32, 64, 64, 64),  # Output to unet3, unicom_n9
    }
    ...
    # UNet3 configuration (combining encoder3 and decoder3)
    node_configs_unet3 = {
        "n0": (32, 64, 64, 64),   # Input from unet2 n15
        "n5": (32, 64, 64, 64),
        "n6": (64, 32, 32, 32),
        "n7": (128, 16, 16, 16),
        "n8": (256, 8, 8, 8),
    ...
    # Unicom_n5 (8x8x8, 256 channels, combining unicom_n5_0 and unicom_n5_1)
    node_configs_unicom_n5 = {
        "n0": (256, 8, 8, 8),  # From unet1 n8
        "n1": (256, 8, 8, 8),  # From unet1 n10
        "n2": (256, 8, 8, 8),  # From unet2 n8
        "n3": (256, 8, 8, 8),  # From unet2 n10
    ...
    # Unicom_n6 (16x16x16, 128 channels, combining unicom_n6_0 and unicom_n6_1)
    node_configs_unicom_n6 = {
        "n0": (128, 16, 16, 16),  # From unet1 n7
        "n1": (128, 16, 16, 16),  # From unet1 n11
        "n2": (128, 16, 16, 16),  # From unet2 n7
        "n3": (128, 16, 16, 16),  # From unet2 n11
    ...
    # Unicom_n7 (32x32x32, 64 channels, combining unicom_n7_0 and unicom_n7_1)
    node_configs_unicom_n7 = {
        "n0": (64, 32, 32, 32),  # From unet1 n6
        "n1": (64, 32, 32, 32),  # From unet1 n12
        "n2": (64, 32, 32, 32),  # From unet2 n6
        "n3": (64, 32, 32, 32),  # From unet2 n12
    ...
    # Unicom_n8 (64x64x64, 32 channels, combining unicom_n8_0 and unicom_n8_1)
    node_configs_unicom_n8 = {
        "n0": (32, 64, 64, 64),  # From unet1 n5
        "n1": (32, 64, 64, 64),  # From unet1 n13
        "n2": (32, 64, 64, 64),  # From unet2 n5
        "n3": (32, 64, 64, 64),  # From unet2 n13
    ...
    # Unicom_n9 (64x64x64, 32 channels, combining unicom_n9_0 and unicom_n9_1)
    node_configs_unicom_n9 = {
        ...
        "n6": (32, 64, 64, 64),  # From unet2 n0
        "n7": (32, 64, 64, 64),  # From unet2 n14
        "n8": (32, 64, 64, 64),  # To unet3 n0
        "n9": (32, 64, 64, 64),  # To unet3 n14
    }
    hyperedge_configs_unicom_n9 = {
        ...
        "e2": {
            ...
            "dst_nodes": ["n8", "n9"],
            "params": {
                "convs": [torch.Size([64, 101, 1, 1, 1])],  # 1+1+1+1+1+32+32+32=101
                "reqs": [True],
                "norms": ["batch"],
                "acts": [None],
                "feature_size": (64, 64, 64),
    ...
    optimizer = optim.Adam([
        {'params': unet1_params, 'lr': learning_rate / 4, 'weight_decay': weight_decay / 4},
        {'params': unet2_params, 'lr': learning_rate / 2, 'weight_decay': weight_decay / 2},
