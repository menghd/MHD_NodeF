...
# Classifier for n9 (512 channels, 4x4x4) - bottleneck
    ...
    ("n124", "classifier_n9", "n0"),
    ("n125", "unet2", "n10"),
    ("n125", "uniconnnet_n10", "n3"),
    ("n125", "classifier_n10", "n0"),
    ("n126", "unet2", "n11"),
    ("n126", "uniconnnet_n11", "n3"),
    ("n126", "classifier_n11", "n0"),
    ("n127", "unet2", "n12"),
    ("n127", "uniconnnet_n12", "n3"),
    ("n127", "classifier_n12", "n0"),
    ("n128", "unet2", "n13"),
    ("n128", "uniconnnet_n13", "n3"),
    ("n128", "classifier_n13", "n0"),
    ("n129", "unet2", "n14"),
    ("n129", "uniconnnet_n14", "n11"),
    ("n129", "classifier_n14", "n0"),
    ("n130", "classifier_n9", "n1"),
    ("n131", "classifier_n10", "n1"),
    ("n132", "classifier_n11", "n1"),
    ("n133", "classifier_n12", "n1"),
    ("n134", "classifier_n13", "n1"),
    ("n135", "classifier_n14", "n1"),
    ("n136", "label_net", "n0"),
    ]
    ...
    in_nodes = ["n100", "n101", "n102", "n103", "n104", "n136"]
    out_nodes = ["n130", "n131", "n132", "n133", "n134", "n135", "n136"]
    ...
    task_configs = {
        "type_cls_n9": {
            "loss": [
                {"fn": node_focal_loss, "origin_node": "n130", "target_node": "n136", "weight": 1.0, "params": {"alpha": [x / invs_sum for x in invs], "gamma": 0}},
            ],
            "metric": [
                {"fn": node_recall_metric, "origin_node": "n130", "target_node": "n136", "params": {}},
                {"fn": node_precision_metric, "origin_node": "n130", "target_node": "n136", "params": {}},
                {"fn": node_f1_metric, "origin_node": "n130", "target_node": "n136", "params": {}},
                {"fn": node_accuracy_metric, "origin_node": "n130", "target_node": "n136", "params": {}},
                {"fn": node_specificity_metric, "origin_node": "n130", "target_node": "n136", "params": {}}
            ]
        },
        "type_cls_n10": {
            "loss": [
                {"fn": node_focal_loss, "origin_node": "n131", "target_node": "n136", "weight": 1.0, "params": {"alpha": [x / invs_sum for x in invs], "gamma": 0}},
            ],
            "metric": [
                {"fn": node_recall_metric, "origin_node": "n131", "target_node": "n136", "params": {}},
                {"fn": node_precision_metric, "origin_node": "n131", "target_node": "n136", "params": {}},
                {"fn": node_f1_metric, "origin_node": "n131", "target_node": "n136", "params": {}},
                {"fn": node_accuracy_metric, "origin_node": "n131", "target_node": "n136", "params": {}},
                {"fn": node_specificity_metric, "origin_node": "n131", "target_node": "n136", "params": {}}
            ]
        },
        "type_cls_n11": {
            "loss": [
                {"fn": node_focal_loss, "origin_node": "n132", "target_node": "n136", "weight": 1.0, "params": {"alpha": [x / invs_sum for x in invs], "gamma": 0}},
            ],
            "metric": [
                {"fn": node_recall_metric, "origin_node": "n132", "target_node": "n136", "params": {}},
                {"fn": node_precision_metric, "origin_node": "n132", "target_node": "n136", "params": {}},
                {"fn": node_f1_metric, "origin_node": "n132", "target_node": "n136", "params": {}},
                {"fn": node_accuracy_metric, "origin_node": "n132", "target_node": "n136", "params": {}},
                {"fn": node_specificity_metric, "origin_node": "n132", "target_node": "n136", "params": {}}
            ]
        },
        "type_cls_n12": {
            "loss": [
                {"fn": node_focal_loss, "origin_node": "n133", "target_node": "n136", "weight": 1.0, "params": {"alpha": [x / invs_sum for x in invs], "gamma": 0}},
            ],
            "metric": [
                {"fn": node_recall_metric, "origin_node": "n133", "target_node": "n136", "params": {}},
                {"fn": node_precision_metric, "origin_node": "n133", "target_node": "n136", "params": {}},
                {"fn": node_f1_metric, "origin_node": "n133", "target_node": "n136", "params": {}},
                {"fn": node_accuracy_metric, "origin_node": "n133", "target_node": "n136", "params": {}},
                {"fn": node_specificity_metric, "origin_node": "n133", "target_node": "n136", "params": {}}
            ]
        },
        "type_cls_n13": {
            "loss": [
                {"fn": node_focal_loss, "origin_node": "n134", "target_node": "n136", "weight": 1.0, "params": {"alpha": [x / invs_sum for x in invs], "gamma": 0}},
            ],
            "metric": [
                {"fn": node_recall_metric, "origin_node": "n134", "target_node": "n136", "params": {}},
                {"fn": node_precision_metric, "origin_node": "n134", "target_node": "n136", "params": {}},
                {"fn": node_f1_metric, "origin_node": "n134", "target_node": "n136", "params": {}},
                {"fn": node_accuracy_metric, "origin_node": "n134", "target_node": "n136", "params": {}},
                {"fn": node_specificity_metric, "origin_node": "n134", "target_node": "n136", "params": {}}
            ]
        },
        "type_cls_n14": {
            "loss": [
                {"fn": node_focal_loss, "origin_node": "n135", "target_node": "n136", "weight": 1.0, "params": {"alpha": [x / invs_sum for x in invs], "gamma": 0}},
            ],
            "metric": [
                {"fn": node_recall_metric, "origin_node": "n135", "target_node": "n136", "params": {}},
                {"fn": node_precision_metric, "origin_node": "n135", "target_node": "n136", "params": {}},
                {"fn": node_f1_metric, "origin_node": "n135", "target_node": "n136", "params": {}},
                {"fn": node_accuracy_metric, "origin_node": "n135", "target_node": "n136", "params": {}},
                {"fn": node_specificity_metric, "origin_node": "n135", "target_node": "n136", "params": {}}
            ]
        }
    }
