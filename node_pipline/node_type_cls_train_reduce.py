...
def main():
    ...
    patience = num_epochs
    num_workers = 16
    scheduler_type = "reduce_plateau"  # Use reduce_plateau scheduler
    warmup_epochs = 20
    eta_min = 0
    reduce_factor = 0.5
    reduce_patience = 10
    ...
    logger.info(f"Using NodeLRScheduler with {scheduler_type}, warmup_epochs={warmup_epochs}, factor={reduce_factor}, patience={reduce_patience}")
