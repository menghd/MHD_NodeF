...
def main():
    ...
    save_dir = r"/data/menghaoding/thu_xwh/new_unicom0_fold1"
    ...
    task_configs = {
        ...
        "type_cls_n6": {
            "loss": [
                {"fn": node_focal_loss, "origin_node": "n116", "target_node": "n120", "weight": 0.5, "params": {"alpha": [x / invs_sum for x in invs], "gamma": 0}},
            ],
            "metric": [
        ...
        "type_cls_n7": {
            "loss": [
                {"fn": node_focal_loss, "origin_node": "n117", "target_node": "n120", "weight": 0.25, "params": {"alpha": [x / invs_sum for x in invs], "gamma": 0}},
            ],
            "metric": [
        ...
        "type_cls_n8": {
            "loss": [
                {"fn": node_focal_loss, "origin_node": "n118", "target_node": "n120", "weight": 0.125, "params": {"alpha": [x / invs_sum for x in invs], "gamma": 0}},
            ],
            "metric": [
        ...
        "type_cls_n9": {
            "loss": [
                {"fn": node_focal_loss, "origin_node": "n119", "target_node": "n120", "weight": 0.0625, "params": {"alpha": [x / invs_sum for x in invs], "gamma": 0}},
            ],
            "metric": [
